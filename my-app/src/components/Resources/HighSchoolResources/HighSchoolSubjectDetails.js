...
function HighSchoolSubjectDetail() {
  ...
  if (!currentSubject) {
    return <div>Subject details not found. Please check the URL or the data in local storage.</div>;
  }
  ...
  return (
    ...
    <div className="book-image">
      <img src={currentSubject.image} alt={`${currentSubject.title} image`} />

    </div>
    <div className="header-description">
      <h2 className="detail-intro">
        <strong>
          Ethiopian Grade {currentSubject.summery.grade} (New Curriculum) {currentSubject.title} Textbook
        </strong>
      </h2>
      <h3 className="detail-intro">
        ...
        <div className="bottom-detail">
          <button
            ...
            id="download-button"
          >
            <img style={{ width: "20px" }} src={pdf} alt="Read Book" /> Read Book
          </button>
          <button
            ...
            id="download-button"
          >
            <img style={{ width: "20px" }} src={download} alt="Download" /> Download
          </button>
        </div>
      </div>
